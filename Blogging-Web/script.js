...
//             blogCard.className = 'animate-blog-card bg-white p-4 rounded-lg shadow-md hover:scale-105 hover:shadow-xl transition-transform flex-none w-[300px] min-w-[300px] sm:flex-1 sm:min-w-0';
