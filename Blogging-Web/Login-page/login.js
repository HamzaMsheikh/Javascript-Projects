...
//     apiKey: "AIzaSyA0M4GLmmCbdszGdi1D6_3lO3sjNFctKag",
//     authDomain: "peperface-9eeee.firebaseapp.com",
//     projectId: "peperface-9eeee",
//     storageBucket: "peperface-9eeee.appspot.com",
//     messagingSenderId: "347456910013",
//     appId: "1:347456910013:web:c11dd5d23dedc5c4647dd4"
// };
...
//             email: email,
//             createdAt: new Date(),
//             isAdmin: email === "admin@peperface.com" ? true : false
//         });
...
adminSignInButton.addEventListener("click", async (event) => {
    ...
    if (email !== "admin@peperface.com") {
        alert("Only admin@peperface.com can log in as admin.");
        return;
    }
    ...
    try {
        ...
        adminLoginModal.classList.add("hidden");
        window.location.href = "../Admin-page/admin.html"; // Fixed redirect path
    } catch (error) {
